...
2. **Be calibrated.** Score each pair on the evidence alone. A wrong-but-high score breaks the receipt. If two angles genuinely fight, say so with a low number.
